...
if ($_POST){
	...
	if ($sra_id != '') {
    $query1 = "update eti_approve_details set approve_a = '2', approve_a_desc = '$reject_level_desc_a',
	...
	$query6 = "insert into eti_approve_details (sra_id,approve_a,approve_a_desc,approve_a_date_time,approve_a_email,approve_a_name) 
				values('$eti_id','2','$reject_level_desc_a','$current_date','$email','$email_name')";
...
<div class="example-modal">
        <div class="modal modal-primary">
          <div class="modal-dialog">
		    <form action="reject_a.php" name="reject" id="reject" onsubmit="return validateForm()" method="post">
