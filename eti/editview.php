 ...
 $dir_path .= $parts[$i] . "/";
   ...
   if($eti_id !='') {
	...
	if ($total_percentage < 0) {
		$price_res = 'Negative';
		$profit =  'Less';
		$total_percentage = abs($total_percentage);
		$price_res = $price_res .' ' . '(' . $total_percentage.'%' . ' ' . $profit . ')';
	} else {
		$price_res = 'Positive';
		$profit =  'More';
		$total_percentage = abs($total_percentage);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="editaction.php" name="editview" id="editview" onsubmit="return validateForm()" method="post" enctype="multipart/form-data" autocomplete="off"> 
        <div class="box-body">
		  <div class="row">
			<div class="col-md-3">
			...
			<div class="col-md-3">
				 <div class="form-group">
					<div class="checkbox">
						<label>
							<input type="checkbox" id="amend" name="amend" value="<?php echo $amend; ?>" <?php if($amend == 'Yes' || $surv_id == 28 || $surv_id == 35 || $job_type == 'Product Sales'){ echo 'checked'; } ?> <?php if($job_type == 'Product Sales' || $surv_id == 28 || $surv_id == 35 || $amend == 'Yes' || $job_type == 'Job') { echo 'disabled'; } ?>> <b><?php echo $amend_lbl; ?></b>
          ...
          <div class="row">
			<div class="col-md-3">
              <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="page_source" id="page_source" value="3" placeholder="3"  readonly>
              </div>
            </div>
            <div class="col-md-3">
             <div class="form-group">
			...
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="text" class="form-control" name="contract_no" id="contract_no" value="<?php echo $contract_no;?>" placeholder="Contract No" <?php if ($access_rights != 2){ echo 'readonly';} ?>>
              </div>
            </div>
          </div>
		  <div class="row">
			...
			<div class="col-md-3">
             <div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name="name" id="name" value="<?php echo $name; ?>" style="width:70%;" placeholder="Name" required>
				</div>
              </div>
            </div>
			<div class="col-md-3">
			...
			<div class="col-md-3">
             <div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name="tel_a" id="tel_a" value="<?php echo $tel_a; ?>" style="width:70%;" placeholder="Telephone" required>
				</div>
              </div>
            </div>
		</div>
			...
			<div class="col-md-3">
             <div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name="tel_b" id="tel_b" placeholder="Telephone" style="width:70%;" value="<?php echo $tel_b; ?>" required>
				</div>
				<div class="checkbox">
                      <label>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
					...
					<input type="text" class="form-control" style="width:90%; display: inline;" name="sra" id="sra" value="<?php echo $sra; ?>" placeholder="SRA" required>&nbsp;&nbsp;<span style="width:10%; display: inline;" id="sra_status"></span>
		...
		<div class="row">
			<div class="col-md-3">
             <div class="form-group">
                <label><?php echo $billing_email_lbl; ?> <span style="color:red">*</span></label>
			...
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="text" class="form-control" name="industry_code" id="industry_code" placeholder="Industry Code" value="<?php echo $industry_code; ?>" readonly>
              </div>
            </div>
			<div class="col-md-3">
             <div class="form-group">
		...
		<div class="row">
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="number" class="form-control" name="prospect_no" id="prospect_no" placeholder="Prospect Number" maxlength = "5" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" value="<?php echo $prospect_no; ?>" style="width:90%; display: inline;" required>&nbsp;&nbsp;<span style="width:10%; display: inline;" id="prospect_no_status"></span>
				<input type="hidden" class="form-control" style="width:90%; display: inline;" name="prospect_no_validation" id="prospect_no_validation" placeholder="SRA" required>
              </div>
            </div>
		</div>
        </div>
		...
		<div class="box-body">
			...
			<div class="row">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="tmt_per_annum_c" id="tmt_per_annum_c" value="<?php echo $tmt_per_annum_cc; ?>" style="text-align:right" placeholder="" step='0.01'>
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="number" min="1" class="form-control" name="price_accept" id="price_accept" value="<?php echo $price_accept; ?>" placeholder="S$" style="text-align:right" readonly>
							<div style="text-align: center;">
								<span id="percentage_result"style="color:red;" ><?php echo $price_res; ?></span>
							</div>
				  </div>
				</div>
			</div>
			...
			<div class="row">
			    ...
			    <div class="col-md-3">
					...
					<?php if($attachment_a != '') { ?><div id="file_a"><a href="<?php echo $attachment_a; ?>" download><?php echo $filename_a; ?></a>&nbsp;&nbsp;<i class="fa fa-times" onclick="delete_file_a();"></i></div> <?php } ?>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
					...
					<?php if($attachment_b != '') { ?><div id="file_b"><a href="<?php echo $attachment_b; ?>" download><?php echo $filename_b; ?></a>&nbsp;&nbsp;<i class="fa fa-times" onclick="delete_file_b();"></i></div><?php } ?>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
					...
					<?php if($attachment_c != '') { ?><div id="file_c"><a href="<?php echo $attachment_c; ?>" download><?php echo $filename_c; ?></a>&nbsp;&nbsp;<i class="fa fa-times" onclick="delete_file_c();"></i></div><?php } ?>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
					...
					<?php if($attachment_d != '') { ?><div id="file_d"><a href="<?php echo $attachment_d; ?>" download><?php echo $filename_d; ?></a>&nbsp;&nbsp;<i class="fa fa-times" onclick="delete_file_d();"></i></div><?php } ?>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
...
$(document).ready(function(){
	$("#actual_gm").hide();
	$("#gm_wo").hide();
	/* var surveyor_id_id = '<?php echo $surv_id; ?>';
	var amend_id = '<?php echo $amend; ?>';

	if (surveyor_id_id == 28 || surveyor_id_id == 35) {
	...
	$("#amend").change(function() {
		...
		$("input[type=hidden][name=" + name + "]").val(($(this).is(":checked") ? "Yes" : ""));
	});
	  ...
	  function total_percentage(){
	   ...
	   $("#surveyor").change(function(){
		...
		if (surveyor_id == 28 || surveyor_id == 35) {
			...
			$("#amend").prop( "disabled",true);
			var name = 'amend';
			$("input[type=hidden][name=" + name + "]").val("Yes");
		} else {
  ...
  function isNumeric (evt) {
	...
	function validateForm() {
		var x = document.forms["editview"]["sra_validation"].value;
		if (x == 2) {
		...
		var y = document.forms["editview"]["prospect_no_validation"].value;
		if (y == 2) {
		...
		var surveyor_code = document.forms["editview"]["surveyor_code"].value; 
		var business_code = document.forms["editview"]["business_code"].value; 
		var industry_code = document.forms["editview"]["industry_code"].value;
		if (surveyor_code == '') {
		...
		var pest_a = document.forms["editview"]["pest_a"].value; 
		var pest_b = document.forms["editview"]["pest_b"].value;
		var pest_c = document.forms["editview"]["pest_c"].value;
		var pest_d = document.forms["editview"]["pest_d"].value;
		var pest_e = document.forms["editview"]["pest_e"].value;
		var pest_f = document.forms["editview"]["pest_f"].value;
		var pest_g = document.forms["editview"]["pest_g"].value;
		var pest_h = document.forms["editview"]["pest_h"].value;
		if (pest_a != '') {
			var visit_annum_a = document.forms["editview"]["visit_annum_a"].value;
			if(visit_annum_a == ''){
		...
		if (pest_b != '') {
			var visit_annum_b = document.forms["editview"]["visit_annum_b"].value;
			if(visit_annum_b == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_c != '') {
			var visit_annum_c = document.forms["editview"]["visit_annum_c"].value;
			if(visit_annum_c == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_d != '') {
			var visit_annum_d = document.forms["editview"]["visit_annum_d"].value;
			if(visit_annum_d == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_e != '') {
			var visit_annum_e = document.forms["editview"]["visit_annum_e"].value;
			if(visit_annum_e == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_f != '') {
			var visit_annum_f = document.forms["editview"]["visit_annum_f"].value;
			if(visit_annum_f == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_g != '') {
			var visit_annum_g = document.forms["editview"]["visit_annum_g"].value;
			if(visit_annum_g == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_h != '') {
			var visit_annum_h = document.forms["editview"]["visit_annum_h"].value;
			if(visit_annum_h == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		var job_type = document.forms["editview"]["job_type"].value;
		var job_duration = document.forms["editview"]["job_duration"].value;
		if(job_type =='Job' && job_duration == ''){
			alert("Please Choose Job Duration !!!");
				document.getElementById("job_duration").focus();
				return false;
		}
		var total_annual_cost = document.forms["editview"]["total_annual_cost"].value;
 ...
 function delete_file_a(){
	var eti_id = document.getElementById("eti_id").value;
