          ...
          <div class="box">
            ...
            <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				    if ($access_rights == 0){
						$query2 = "select a.serial_number,a.id,a.eti_date,a.contract_no,a.sra,a.job_type,a.name,a.premises_address_a,a.tel_b,a.form_status,a.google_drive,b.approve_desc, c.employee_name from eti_sra a LEFT JOIN eti_sra_status b ON a.id = b.sra_id LEFT JOIN eti_portal_user c ON a.created_by = c.id where a.form_status IN (2,3)";
					} else if ($access_rights == 1) {						
						$query2 = "select a.serial_number,a.id,a.eti_date,a.contract_no,a.sra,a.job_type,a.name,a.premises_address_a,a.tel_b,a.form_status,a.google_drive,b.approve_desc, c.employee_name from eti_sra a LEFT JOIN eti_sra_status b ON a.id = b.sra_id LEFT JOIN eti_portal_user c ON a.created_by = c.id where a.created_by = '$session_id' and a.form_status IN (2,3)";
					} else if ($access_rights == 2 || $access_rights == 3) {
						$query2 = "select  a.serial_number,a.id,a.eti_date,a.contract_no,a.sra,a.job_type,a.name,a.premises_address_a,a.tel_b,a.form_status,a.google_drive,b.approve_desc, c.employee_name from eti_sra a LEFT JOIN eti_sra_status b ON a.id = b.sra_id LEFT JOIN eti_portal_user c ON a.created_by = c.id where (a.form_status = 1 OR a.form_status = 2 OR a.form_status = 3) and b.approve_desc = 'Sent To Admin Team' and a.form_status IN (2,3)";
                ...
                <tr>
				  ...
				  <td>
					  ...
					  <?php } ?>
				      <?php if ($res2['form_status'] == 1 || $res2['form_status'] == 3){ ?>
					  <a href="<?php echo $new_path; ?>" target="_blank"><i class="fa fa-download" style="color:red" title="Download"></i></a>
					  <?php } ?>
					  
					  <?php if ((($access_rights == 1 || $access_rights == 0) && $res2['form_status'] == 0) || (($access_rights == 1 || $access_rights == 0) && $res2['form_status'] == 1)){ ?>
					  ...
					  <?php if (($access_rights == 2 && ($res2['contract_no'] == '' || $res2['contract_no'] != '') && $res2['form_status'] == 1)||($res2['contract_no'] == 'ERROR' && $res2['form_status'] == 4)) { ?>
