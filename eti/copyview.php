...
include ("../db/db_connect.php");
   ...
   if($eti_id !='') {
	...
	$coordinate_x = $res1['coordinate_x'];
	$coordinate_y = $res1['coordinate_y'];
	
	$query2 = "select domestic,industrial,commercial,site_plan_others,location,lm,meter,surveyor_name,litre,chemical,chemical_other_desc from eti_site_plan where sra_id='$eti_id'";
	...
	$query3 = "select preparation_id,unit_cost,qty,tot_val_unit,unit_per_tmt,tmt_per_annum,val_per_annum,pest_count,unit_selling,tot_val_cost,val_per_annum_cost from eti_pest_details where sra_id='$eti_id' and pest_count='1'";
	...
	$query4 = "select preparation_id,unit_cost,qty,tot_val_unit,unit_per_tmt,tmt_per_annum,val_per_annum,pest_count,unit_selling,tot_val_cost,val_per_annum_cost from eti_pest_details where sra_id='$eti_id' and pest_count='2'";
	...
	$query5 = "select preparation_id,unit_cost,qty,tot_val_unit,unit_per_tmt,tmt_per_annum,val_per_annum,pest_count,unit_selling,tot_val_cost,val_per_annum_cost from eti_pest_details where sra_id='$eti_id' and pest_count='3'";
	...
	$query6 = "select preparation_id,unit_cost,qty,tot_val_unit,unit_per_tmt,tmt_per_annum,val_per_annum,pest_count,unit_selling,tot_val_cost,val_per_annum_cost from eti_pest_details where sra_id='$eti_id' and pest_count='4'";
	...
	$query7 = "select preparation_id,unit_cost,qty,tot_val_unit,unit_per_tmt,tmt_per_annum,val_per_annum,pest_count,unit_selling,tot_val_cost,val_per_annum_cost from eti_pest_details where sra_id='$eti_id' and pest_count='5'";
	...
	$query8 = "select preparation_id,unit_cost,qty,tot_val_unit,unit_per_tmt,tmt_per_annum,val_per_annum,pest_count,unit_selling,tot_val_cost,val_per_annum_cost from eti_pest_details where sra_id='$eti_id' and pest_count='6'";
	...
	$query9 = "select preparation_id,unit_cost,qty,tot_val_unit,unit_per_tmt,tmt_per_annum,val_per_annum,pest_count,unit_selling,tot_val_cost,val_per_annum_cost from eti_pest_details where sra_id='$eti_id' and pest_count='7'";
	...
	$query10 = "select preparation_id,unit_cost,qty,tot_val_unit,unit_per_tmt,tmt_per_annum,val_per_annum,pest_count,unit_selling,tot_val_cost,val_per_annum_cost from eti_pest_details where sra_id='$eti_id' and pest_count='8'";
	...
	$query11 = "select shift_type,per_hour,no_hours,total_hours,tmt_hours,tmt_annum,labour_value,labour_count,fix_cost_per_hour,wfix_cost_per_hour,fix_cost_total_hours,wfix_cost_total_hours,fix_cost_labour_value,wfix_cost_labour_value from eti_labour_details where sra_id='$eti_id' and labour_count='1'";
	...
	$query13 = "select shift_type,per_hour,no_hours,total_hours,tmt_hours,tmt_annum,labour_value,labour_count,fix_cost_per_hour,wfix_cost_per_hour,fix_cost_total_hours,wfix_cost_total_hours,fix_cost_labour_value,wfix_cost_labour_value from eti_labour_details where sra_id='$eti_id' and labour_count='2'";
	...
	$query14 = "select shift_type,per_hour,no_hours,total_hours,tmt_hours,tmt_annum,labour_value,labour_count,fix_cost_per_hour,wfix_cost_per_hour,fix_cost_total_hours,wfix_cost_total_hours,fix_cost_labour_value,wfix_cost_labour_value from eti_labour_details where sra_id='$eti_id' and labour_count='3'";
	...
	$query15 = "select shift_type,per_hour,no_hours,total_hours,tmt_hours,tmt_annum,labour_value,labour_count,fix_cost_per_hour,wfix_cost_per_hour,fix_cost_total_hours,wfix_cost_total_hours,fix_cost_labour_value,wfix_cost_labour_value from eti_labour_details where sra_id='$eti_id' and labour_count='4'";
	...
	$query16 = "select type,other_unit_cost,other_item,other_tot_val,other_tot_item,other_tmt_annum,other_tot_annum,other_count from eti_other_details where sra_id='$eti_id' and other_count='1'";
	...
	$query17 = "select type,other_unit_cost,other_item,other_tot_val,other_tot_item,other_tmt_annum,other_tot_annum,other_count from eti_other_details where sra_id='$eti_id' and other_count='2'";
	...
	$query19 = "select pest_id,qty,instruction,visit_annum,add_freq,annual_value,product_count from eti_product_details where sra_id='$eti_id' and product_count='1'";
	...
	$pest_condition_aa = $res19['pest_condition'];
	$condition_ref_aa = $res19['condition_ref'];
	$product_count_aa = $res19['product_count'];
	
	$query20 = "select pest_id,qty,instruction,visit_annum,add_freq,annual_value,product_count from eti_product_details where sra_id='$eti_id' and product_count='2'";
	...
	$pest_condition_bb = $res20['pest_condition'];
	$condition_ref_bb = $res20['condition_ref'];
	$product_count_bb = $res20['product_count'];
	
	$query21 = "select pest_id,qty,instruction,visit_annum,add_freq,annual_value,product_count from eti_product_details where sra_id='$eti_id' and product_count='3'";
	...
	$pest_condition_cc = $res21['pest_condition'];
	$condition_ref_cc = $res21['condition_ref'];
	$product_count_cc = $res21['product_count'];
	
	$query22 = "select pest_id,qty,instruction,visit_annum,add_freq,annual_value,product_count from eti_product_details where sra_id='$eti_id' and product_count='4'";
	...
	$pest_condition_dd = $res22['pest_condition'];
	$condition_ref_dd = $res22['condition_ref'];
	$product_count_dd = $res22['product_count'];
	
	$query23 = "select pest_id,qty,instruction,visit_annum,add_freq,annual_value,product_count from eti_product_details where sra_id='$eti_id' and product_count='5'";
	...
	$pest_condition_ee = $res23['pest_condition'];
	$condition_ref_ee = $res23['condition_ref'];
	$product_count_ee = $res23['product_count'];
	
	$query24 = "select pest_id,qty,instruction,visit_annum,add_freq,annual_value,product_count from eti_product_details where sra_id='$eti_id' and product_count='6'";
	...
	$pest_condition_ff = $res24['pest_condition'];
	$condition_ref_ff = $res24['condition_ref'];
	$product_count_ff = $res24['product_count'];
	
	$query25 = "select pest_id,qty,instruction,visit_annum,add_freq,annual_value,product_count from eti_product_details where sra_id='$eti_id' and product_count='7'";
	...
	$pest_condition_gg = $res25['pest_condition'];
	$condition_ref_gg = $res25['condition_ref'];
	$product_count_gg = $res25['product_count'];
	
	$query26 = "select pest_id,qty,instruction,visit_annum,add_freq,annual_value,product_count from eti_product_details where sra_id='$eti_id' and product_count='8'";
	...
	$pest_condition_hh = $res26['pest_condition'];
	$condition_ref_hh = $res26['condition_ref'];
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="addaction.php" name="copyview" id="copyview" onsubmit="return validateForm()" method="post" enctype="multipart/form-data" autocomplete="off"> 
        <div class="box-body">
		  <div class="row">
			<div class="col-md-3">
			...
			<div class="col-md-3">
				 <div class="form-group">
					<div class="checkbox">
						<label>
							<input type="checkbox" id="amend" name="amend" value="Yes" <?php if($amend == 'Yes' || $surv_id == 28 || $job_type == 'Product Sales'){ echo 'checked'; } ?> <?php if($job_type == 'Product Sales' || $surv_id == 28 || $amend == 'Yes' || $job_type == 'Job') { echo 'disabled'; } ?>> <b><?php echo $amend_lbl; ?></b>
						</label>
					</div>
				  </div>
			</div>
          ...
          <div class="row">
			<div class="col-md-3">
              <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="page_source" id="page_source" value="2" placeholder="2"  readonly>
              </div>
            </div>
            <div class="col-md-3">
             <div class="form-group">
			...
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="text" class="form-control" name="contract_no" id="contract_no" placeholder="Contract No" readonly>
              </div>
            </div>
          </div>
		  <div class="row">
             ...
             <div class="form-group">
                ...
                <div class="input-group">
					<select name="salutation" class="form-control" id="salutation" style="width:30%;" required>
						...
						<option value="Mdm." <?php if($salutation == 'Mdm.') { echo 'selected="selected"'; }?>>Mdm.</option>
						<option value="Mrs." <?php if($salutation == 'Mrs.') { echo 'selected="selected"'; }?>>Mrs.</option>
					</select>
					<input type="text" class="form-control" name="name" id="name" style="width:70%;" value="<?php echo $name; ?>" placeholder="Name" required>
				</div>
              </div>
            </div>
			<div class="col-md-3">
		...
		<div class="row">
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="text" class="form-control" maxlength="40" name="address_a" id="address_a" value="<?php echo $address_a; ?>" placeholder="Address" required>
              </div>
            </div>
			<div class="col-md-3">
             <div class="form-group">
                <label><?php echo $address_b_lbl; ?></label>
                <input type="text" class="form-control" maxlength="40" name="address_b" id="address_b" value="<?php echo $address_b; ?>" placeholder="Address">
              </div>
            </div>
			<div class="col-md-3">
             <div class="form-group">
			...
			<div class="col-md-3">
             <div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name="tel_a" id="tel_a" style="width:70%;" value="<?php echo $tel_a; ?>" placeholder="Telephone" required>
				</div>
              </div>
            </div>
		</div>
		<div class="row">
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="text" class="form-control" maxlength="40" name="premises_address_a" id="premises_address_a" value="<?php echo $premises_address_a; ?>" placeholder="Address" required>
              </div>
            </div>
			<div class="col-md-3">
             <div class="form-group">
                <label><?php echo $premises_address_b_lbl; ?></label>
                <input type="text" class="form-control" maxlength="40" name="premises_address_b" id="premises_address_b" value="<?php echo $premises_address_b; ?>" placeholder="Address">
              </div>
            </div>
			<div class="col-md-3">
             <div class="form-group">
			...
			<div class="col-md-3">
             <div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name="tel_b" id="tel_b" style="width:70%;" placeholder="Telephone" value="<?php echo $tel_b; ?>" required>
				</div>
				<div class="checkbox">
                      <label>
		...
		<div class="row">
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="number" class="form-control" name="prospect_no" id="prospect_no" placeholder="Prospect Number" maxlength = "6" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" style="width:90%; display: inline;" value="<?php echo $prospect_no; ?>" required>&nbsp;&nbsp;<span style="width:10%; display: inline;" id="sra_status"></span>
				<input type="hidden" class="form-control" style="width:90%; display: inline;" name="sra_validation" id="sra_validation" placeholder="SRA" required>
              </div>
            </div>
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="number" class="form-control" name="coordinate_x" id="coordinate_x" value="<?php echo $coordinate_x; ?>" step="any" min="103.6" max="104.1" placeholder="Coordinate X" required>
              </div>
            </div>
			<div class="col-md-3">
             <div class="form-group">
                <label><?php echo $coordinate_y_lbl; ?></label><span style="color:red">*</span>
                <input type="number" class="form-control" name="coordinate_y" id="coordinate_y" value="<?php echo $coordinate_y; ?>" step="any" min="1.20" max="1.47" placeholder="Coordinate Y" required>
              </div>
            </div>
		</div>
        </div>
		...
		<div class="box-body">
			...
			<div class="col-md-3">
             <div class="form-group">
                ...
                <input type="text" class="form-control" name="site_plan_others" id="site_plan_others" value="<?php echo $site_plan_others; ?>" placeholder="Others" >
              </div>
            </div>
			</div>
			<div class="row">
				<div class="col-md-3">
				 <div class="form-group">
					...
					<input type="text" class="form-control" name="location" id="location" value="<?php echo $location; ?>" placeholder="Location of Site" >
				  </div>
				</div>
				<div class="col-md-3">
				 <div class="form-group">
					<label><?php echo $area_treatment_lbl; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<input type="text" class="form-control" name="lm" id="lm" value="<?php echo $lm; ?>" style="display:inline-block;width:35%;" ><div style="display:inline-block;width:14%;">&nbsp;<?php echo $lm_lbl; ?></div>
					<input type="text" class="form-control" name="meter" id="meter" value="<?php echo $meter; ?>" style="display:inline-block;width:35%;" ><div style="display:inline-block;width:14%;">&nbsp;<?php echo $meter_lbl; ?><sup>2</sup></div>
				  </div>
				</div>
				<div class="col-md-3">
				 <div class="form-group">
				...
				<div class="col-md-3">
				 <div class="form-group">
					...
					<input type="text" class="form-control" name="litre" id="litre" value="<?php echo $litre; ?>" placeholder="No. of Liters" >
				  </div>
				</div>
			</div>
			<div class="row">
			 ...
			 <label> <?php echo $chemical_lbl; ?> &nbsp;&nbsp; </label>
				<label><input type="radio" name="chemical" id="chemical" value="Premise 200 SC" <?php if($chemical == 'Premise 200 SC') { echo 'checked'; } ?>>&nbsp;<?php echo $chemical_premise_lbl; ?></label>
			 </div>
			 <div class="col-md-3">
				 <label></label>
				<label><input type="radio" name="chemical" id="chemical" value="Optigrad termite liquid" <?php if($chemical == 'Optigrad termite liquid') { echo 'checked'; } ?> >&nbsp;<?php echo $chemical_optigrad_lbl; ?> </label>
			 </div>
			 <div class="col-md-3">
				 <label></label>
				<label><input type="radio" name="chemical" id="chemical" value="Ultrathor" <?php if($chemical == 'Wazary 10 FL') { echo 'checked'; } ?>>&nbsp;<?php echo $chemical_wazary_lbl; ?></label>
			 </div>
			 <div class="col-md-3">
				 <label></label>
				<label><input type="radio" name="chemical" id="chemical" value="Altriset" <?php if($chemical == 'Agenda 10 SC') { echo 'checked'; } ?>>&nbsp;<?php echo $chemical_agenda_lbl; ?></label>
			 </div>
			  <div class="col-md-3">
				<label>
					<input type="checkbox" name="chemical_other"  id="chemical_other" <?php if($chemical_other_desc != ''){ echo 'checked'; } ?>>&nbsp;<?php echo $chemical_others_lbl; ?>
					<input type="text" style="width:75%; display:inline;" class="form-control" name="chemical_other_desc" id="chemical_other_desc" value="<?php echo $chemical_other_desc; ?>">
				</label>
			 </div>
			</div> <br>
			...
			<div class="row">
				...
				<div class="col-md-1">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="pest_qty_a" id="pest_qty_a" value="<?php echo $pest_qty_aa; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label><?php echo $instruction_lbl; ?></label>
						<input type="text" class="form-control" name="instruction_a" id="instruction_a" value="<?php echo $instruction_aa; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="add_freq_a" id="add_freq_a" value="<?php echo $add_freq_aa; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label><?php echo $annual_value_lbl; ?></label>
						<input type="number" min="0" class="form-control" name="annual_value_a" id="annual_value_a" value="<?php echo $annual_value_aa; ?>" placeholder="" step="any" <?php if ($condition_ref_aa == 1) { echo 'readonly';}?>>
						<input type="hidden" class="form-control" name="product_count_a" id="product_count_a" value="1" placeholder="" >
						<input type="hidden" class="form-control" name="condition1" id="condition1" value="<?php echo $pest_condition_aa; ?>" placeholder="">
						<input type="hidden" class="form-control" name="condition_ref1" id="condition_ref1" value="<?php echo $condition_ref_aa; ?>" placeholder="">
				  </div>
				</div>
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="pest_qty_b" id="pest_qty_b" value="<?php echo $pest_qty_bb; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="instruction_b" id="instruction_b" value="<?php echo $instruction_bb; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="add_freq_b" id="add_freq_b" value="<?php echo $add_freq_bb; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="number" min="0" class="form-control" name="annual_value_b" id="annual_value_b" value="<?php echo $annual_value_bb; ?>" placeholder="" step="any" <?php if ($condition_ref_bb == 1) { echo 'readonly';}?>>
						<input type="hidden" class="form-control" name="product_count_b" id="product_count_b" value="2" placeholder="" >
						<input type="hidden" class="form-control" name="condition2" id="condition2" value="<?php echo $pest_condition_bb; ?>" placeholder="">
						<input type="hidden" class="form-control" name="condition_ref2" id="condition_ref2" value="<?php echo $condition_ref_bb; ?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="pest_qty_c" id="pest_qty_c" value="<?php echo $pest_qty_cc; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="instruction_c" id="instruction_c" value="<?php echo $instruction_cc; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="add_freq_c" id="add_freq_c" value="<?php echo $add_freq_cc; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="number" min="0" class="form-control" name="annual_value_c" id="annual_value_c" value="<?php echo $annual_value_cc; ?>" placeholder="" step="any" <?php if ($condition_ref_cc == 1) { echo 'readonly';}?>>
						<input type="hidden" class="form-control" name="product_count_c" id="product_count_c" value="3" placeholder="" >
						<input type="hidden" class="form-control" name="condition3" id="condition3" value="<?php echo $pest_condition_cc; ?>" placeholder="">
						<input type="hidden" class="form-control" name="condition_ref3" id="condition_ref3" value="<?php echo $condition_ref_cc; ?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="pest_qty_d" id="pest_qty_d" value="<?php echo $pest_qty_dd; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="instruction_d" id="instruction_d" value="<?php echo $instruction_dd; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="add_freq_d" id="add_freq_d" value="<?php echo $add_freq_dd; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="number" min="0" class="form-control" name="annual_value_d" id="annual_value_d" value="<?php echo $annual_value_dd; ?>" placeholder="" step="any" <?php if ($condition_ref_dd == 1) { echo 'readonly';}?>>
						<input type="hidden" class="form-control" name="product_count_d" id="product_count_d" value="4" placeholder="" >
						<input type="hidden" class="form-control" name="condition4" id="condition4" value="<?php echo $pest_condition_dd; ?>" placeholder="">
						<input type="hidden" class="form-control" name="condition_ref4" id="condition_ref4" value="<?php echo $condition_ref_dd; ?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="pest_qty_e" id="pest_qty_e" value="<?php echo $pest_qty_ee; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="instruction_e" id="instruction_e" value="<?php echo $instruction_ee; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="add_freq_e" id="add_freq_e" value="<?php echo $add_freq_ee; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="number" min="0" class="form-control" name="annual_value_e" id="annual_value_e" value="<?php echo $annual_value_ee; ?>" placeholder="" step="any" <?php if ($condition_ref_ee == 1) { echo 'readonly';}?>>
						<input type="hidden" class="form-control" name="product_count_e" id="product_count_e" value="5" placeholder="" >
						<input type="hidden" class="form-control" name="condition5" id="condition5" value="<?php echo $pest_condition_ee; ?>" placeholder="">
						<input type="hidden" class="form-control" name="condition_ref5" id="condition_ref5" value="<?php echo $condition_ref_ee; ?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="pest_qty_f" id="pest_qty_f" value="<?php echo $pest_qty_ff; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="instruction_f" id="instruction_f" value="<?php echo $instruction_ff; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="add_freq_f"  id="add_freq_f" value="<?php echo $add_freq_ff; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="number" min="0" class="form-control" name="annual_value_f" id="annual_value_f" value="<?php echo $annual_value_ff; ?>" placeholder="" step="any" <?php if ($condition_ref_ff == 1) { echo 'readonly';}?>>
						<input type="hidden" class="form-control" name="product_count_f" id="product_count_f" value="6" placeholder="" >
						<input type="hidden" class="form-control" name="condition6" id="condition6" value="<?php echo $pest_condition_ff; ?>" placeholder="">
						<input type="hidden" class="form-control" name="condition_ref6" id="condition_ref6" value="<?php echo $condition_ref_ff; ?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="pest_qty_g" id="pest_qty_g" value="<?php echo $pest_qty_gg; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="instruction_g" id="instruction_g" value="<?php echo $instruction_gg; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="add_freq_g" id="add_freq_g" value="<?php echo $add_freq_gg; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="number" min="0" class="form-control" name="annual_value_g" id="annual_value_g" value="<?php echo $annual_value_gg; ?>" placeholder="" step="any" <?php if ($condition_ref_gg == 1) { echo 'readonly';}?>>
						<input type="hidden" class="form-control" name="product_count_g" id="product_count_g" value="7" placeholder="" >
						<input type="hidden" class="form-control" name="condition7" id="condition7" value="<?php echo $pest_condition_gg; ?>" placeholder="">
						<input type="hidden" class="form-control" name="condition_ref7" id="condition_ref7" value="<?php echo $condition_ref_gg; ?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="pest_qty_h" id="pest_qty_h" value="<?php echo $pest_qty_hh; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="instruction_h" id="instruction_h" value="<?php echo $instruction_hh; ?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="add_freq_h" value="<?php echo $add_freq_hh; ?>" id="add_freq_h" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="number" min="0" class="form-control" name="annual_value_h" id="annual_value_h" value="<?php echo $annual_value_hh; ?>" placeholder="" step="any" <?php if ($condition_ref_hh == 1) { echo 'readonly';}?>>
						<input type="hidden" class="form-control" name="product_count_h" id="product_count_h" value="8" placeholder="" >
						<input type="hidden" class="form-control" name="condition8" id="condition8" value="<?php echo $pest_condition_hh; ?>" placeholder="">
						<input type="hidden" class="form-control" name="condition_ref8" id="condition_ref8" value="<?php echo $condition_ref_hh; ?>" placeholder="">
				  </div>
				</div>
			</div> <br>
			...
			<div class="row">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label><?php echo $qty_lbl; ?></label>
						<input type="number" class="form-control" name="qty_a" id="qty_a" value="<?php echo $qty_aa; ?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						...
						<input type="number" class="form-control" name="unit_per_tmt_a" id="unit_per_tmt_a" value="<?php echo $unit_per_tmt_aa;?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label><?php echo $tmt_per_annum_lbl; ?></label>
						<input type="number" min="1" class="form-control" name="tmt_per_annum_a" id="tmt_per_annum_a" value="<?php echo $tmt_per_annum_aa; ?>" style="text-align:right" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="qty_b" id="qty_b" value="<?php echo $qty_bb; ?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="unit_per_tmt_b" id="unit_per_tmt_b" value="<?php echo $unit_per_tmt_bb;?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="tmt_per_annum_b" id="tmt_per_annum_b" value="<?php echo $tmt_per_annum_bb; ?>" style="text-align:right" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="qty_c" id="qty_c" value="<?php echo $qty_cc; ?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="unit_per_tmt_c" id="unit_per_tmt_c" value="<?php echo $unit_per_tmt_cc;?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="tmt_per_annum_c" id="tmt_per_annum_c" value="<?php echo $tmt_per_annum_cc; ?>" style="text-align:right" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="qty_d" id="qty_d" value="<?php echo $qty_dd; ?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="unit_per_tmt_d" id="unit_per_tmt_d" value="<?php echo $unit_per_tmt_dd;?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="tmt_per_annum_d" id="tmt_per_annum_d" value="<?php echo $tmt_per_annum_dd; ?>" style="text-align:right" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="qty_e" id="qty_e" value="<?php echo $qty_ee; ?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="unit_per_tmt_e" id="unit_per_tmt_e" value="<?php echo $unit_per_tmt_ee;?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="tmt_per_annum_e" id="tmt_per_annum_e" value="<?php echo $tmt_per_annum_ee; ?>" style="text-align:right" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="qty_f" id="qty_f" value="<?php echo $qty_ff; ?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="unit_per_tmt_f" id="unit_per_tmt_f" value="<?php echo $unit_per_tmt_ff;?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="tmt_per_annum_f" id="tmt_per_annum_f" value="<?php echo $tmt_per_annum_ff; ?>" style="text-align:right" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="qty_g" id="qty_g" value="<?php echo $qty_gg; ?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="unit_per_tmt_g" id="unit_per_tmt_g" value="<?php echo $unit_per_tmt_gg;?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="tmt_per_annum_g" id="tmt_per_annum_g" value="<?php echo $tmt_per_annum_gg; ?>" style="text-align:right" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="qty_h" id="qty_h" value="<?php echo $qty_hh; ?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" class="form-control" name="unit_per_tmt_h" id="unit_per_tmt_h" value="<?php echo $unit_per_tmt_hh;?>" style="text-align:right" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="tmt_per_annum_h" id="tmt_per_annum_h" value="<?php echo $tmt_per_annum_hh; ?>" style="text-align:right" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-1">
					<div class="form-group">
						...
						<input type="number" class="form-control" name="no_hours_a" value="<?php echo $no_hours_aa;?>" id="no_hours_a" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<input type="time" class="form-control" name="tmt_hours_a" id="tmt_hours_a" value="<?php echo $tmt_hours_aa;?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label><?php echo $tmt_annum_lbl; ?></label>
						<input type="number" min="1" class="form-control" name="tmt_annum_a" id="tmt_annum_a" value="<?php echo $tmt_annum_aa;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label><br>
						<input type="number" class="form-control" name="no_hours_b" id="no_hours_b" value="<?php echo $no_hours_bb;?>" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label></label><br>
						<input type="time" class="form-control" name="tmt_hours_b" id="tmt_hours_b" value="<?php echo $tmt_hours_bb;?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label><br>
						<input type="number" min="1" class="form-control" name="tmt_annum_b" id="tmt_annum_b" value="<?php echo $tmt_annum_bb;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label><br>
						<input type="number" class="form-control" name="no_hours_c" id="no_hours_c" value="<?php echo $no_hours_cc;?>" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label></label><br>
						<input type="time" class="form-control" name="tmt_hours_c" id="tmt_hours_c" value="<?php echo $tmt_hours_cc;?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label><br>
						<input type="number" min="1" class="form-control" name="tmt_annum_c" id="tmt_annum_c" value="<?php echo $tmt_annum_cc;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label><br>
						<input type="number" class="form-control" name="no_hours_d" id="no_hours_d" value="<?php echo $no_hours_dd;?>" placeholder="" step="0.01">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label></label><br>
						<input type="time" class="form-control" name="tmt_hours_d" id="tmt_hours_d" value="<?php echo $tmt_hours_dd;?>" placeholder="">
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label><br>
						<input type="number" min="1" class="form-control" name="tmt_annum_d" id="tmt_annum_d" value="<?php echo $tmt_annum_dd;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="type_a" id="type_a" value="<?php echo $type_aa;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label><?php echo $unit_cost_lbl; ?></label>
						<input type="number" min="1" class="form-control" name="other_unit_cost_a" id="other_unit_cost_a" value="<?php echo $other_unit_cost_aa;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label><?php echo $no_items_lbl; ?></label>
						<input type="number" min="1" class="form-control" name="other_item_a" id="other_item_a" value="<?php echo $other_item_aa;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						...
						<input type="number" min="1" class="form-control" name="other_tot_item_a" id="other_tot_item_a" value="<?php echo $other_tot_item_aa;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label><?php echo $oth_tmt_annum_lbl; ?></label>
						<input type="number" min="1" class="form-control" name="other_tmt_annum_a" id="other_tmt_annum_a" value="<?php echo $other_tmt_annum_aa;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="text" class="form-control" name="type_b" id="type_b" value="<?php echo $type_bb;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="other_unit_cost_b" id="other_unit_cost_b" value="<?php echo $other_unit_cost_bb;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="other_item_b" id="other_item_b" value="<?php echo $other_item_bb;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="other_tot_item_b" id="other_tot_item_b" value="<?php echo $other_tot_item_bb;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-1">
					<div class="form-group">
						<label></label>
						<input type="number" min="1" class="form-control" name="other_tmt_annum_b" id="other_tmt_annum_b" value="<?php echo $other_tmt_annum_bb;?>" placeholder="" >
				  </div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						...
						<textarea class="form-control" id="finance_note" name="finance_note" rows="3"><?php echo $finance_note; ?></textarea>
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label><?php echo $service_note_lbl; ?></label><br>
						<textarea class="form-control" id="service_note" name="service_note" rows="3"><?php echo $service_note; ?></textarea>
				  </div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						...
						<select name="billing_frequency" id="billing_frequency" class="form-control" required>
							...
							<option value="Job (Select Invoice Type)" <?php if($billing_frequency == 'One Time Invoice (Job)' || $billing_frequency == 'Job (Select Invoice Type)') { echo 'selected="selected"'; }?>>Job (Select Invoice Type)</option>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="po_number" id="po_number" placeholder="PO Number" value="<?php echo $po_number; ?>">
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
...
<script>
	...
	$("#tmt_hours_a").blur(function(){
	  ...
	  $("#job_type").change(function(){
		 ...
		 if (job_type == 'Job' || job_type == 'Product Sales'){
			...
			$("#billing_frequency option[value='Visit Trigger']").hide();
			$("#billing_frequency option[value='Visit Trigger Monthly']").hide();
			$("#billing_frequency option[value='Progressive Billing(ST)']").hide();
			...
			$("#billing_frequency option[value='Visit Trigger']").show();
			$("#billing_frequency option[value='Visit Trigger Monthly']").show();
			$("#billing_frequency option[value='Progressive Billing(ST)']").show();
			$("#billing_frequency option").each(function () {
				$(this).removeAttr("selected", "selected");
  ...
  function validateForm() {
	    //alert('asdas'); return false;
		var x = document.forms["copyview"]["sra_validation"].value;
		...
		var y = document.forms["copyview"]["prospect_no_validation"].value;
		if (y == 2) {
		...
		var surveyor_code = document.forms["copyview"]["surveyor_code"].value; 
		var business_code = document.forms["copyview"]["business_code"].value; 
		var industry_code = document.forms["copyview"]["industry_code"].value;
		if (surveyor_code == '') {
		...
		var pest_a = document.forms["copyview"]["pest_a"].value; 
		var pest_b = document.forms["copyview"]["pest_b"].value;
		var pest_c = document.forms["copyview"]["pest_c"].value;
		var pest_d = document.forms["copyview"]["pest_d"].value;
		var pest_e = document.forms["copyview"]["pest_e"].value;
		var pest_f = document.forms["copyview"]["pest_f"].value;
		var pest_g = document.forms["copyview"]["pest_g"].value;
		var pest_h = document.forms["copyview"]["pest_h"].value;
		if (pest_a != '') {
			var visit_annum_a = document.forms["copyview"]["visit_annum_a"].value;
			if(visit_annum_a == ''){
		...
		if (pest_b != '') {
			var visit_annum_b = document.forms["copyview"]["visit_annum_b"].value;
			if(visit_annum_b == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_c != '') {
			var visit_annum_c = document.forms["copyview"]["visit_annum_c"].value;
			if(visit_annum_c == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_d != '') {
			var visit_annum_d = document.forms["copyview"]["visit_annum_d"].value;
			if(visit_annum_d == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_e != '') {
			var visit_annum_e = document.forms["copyview"]["visit_annum_e"].value;
			if(visit_annum_e == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_f != '') {
			var visit_annum_f = document.forms["copyview"]["visit_annum_f"].value;
			if(visit_annum_f == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_g != '') {
			var visit_annum_g = document.forms["copyview"]["visit_annum_g"].value;
			if(visit_annum_g == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		if (pest_h != '') {
			var visit_annum_h = document.forms["copyview"]["visit_annum_h"].value;
			if(visit_annum_h == ''){
				alert("Please Choose Visit Frequency Per Annum!!!");
		...
		var job_type = document.forms["copyview"]["job_type"].value;
		var job_duration = document.forms["copyview"]["job_duration"].value;
		if(job_type =='Job' && job_duration == ''){
			alert("Please Choose Job Duration !!!");
				document.getElementById("job_duration").focus();
				return false;
		}
		var total_annual_cost = document.forms["copyview"]["total_annual_cost"].value;
