...
if ($_POST){
	$reject_level_desc_b = $_POST['reject_level_desc_b'];
	$eti_id = $_POST['eti'];
	$email = $_POST['email'];
	...
	$sra_id = $res['id'];
	if ($sra_id != '') {
    $query1 = "update eti_approve_details set approve_b = '2', approve_b_desc = '$reject_level_desc_b',
	...
	$query6 = "insert into eti_approve_details (sra_id,approve_b,approve_b_desc,approve_b_date_time,approve_b_email,approve_b_name) 
				values('$eti_id','2','$reject_level_desc_b','$current_date','$email','$email_name')";
	...
	$query111 = "update eti_sra_status set approve_desc = '$approve_desc', approve_date_time = '$current_date',
			   approve_email_id='$email',approve_name='$email_name', user_id='' where sra_id = '$eti_id'";
	$exec111 = mysql_query($query111) or die ("Error in Query111".mysql_error());
...
<div class="example-modal">
        <div class="modal modal-primary">
          <div class="modal-dialog">
		    <form action="reject_b.php" name="reject" id="reject" onsubmit="return validateForm()" method="post">
