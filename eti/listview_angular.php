      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="table-responsive" ng-app="etiApp" ng-controller="etiController">
              <table datatable="ng" dt-options="vm.dtOptions" id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
...
function initDT(DTDefaultOptions) {
    DTDefaultOptions.setLoadingTemplate('<img src="../images/update_e.gif">');
}
angular.module('etiApp', ['etiApp.controllers','datatables']);
angular.module('etiApp.controllers', []).controller('etiController', function($scope,$http) {
$http.get('fetch.php').success(function(etiData){
$scope.etiList = etiData;
});
});
})(angular);	
