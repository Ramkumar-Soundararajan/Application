...
if (isset($_POST['submit'])){
	...
	if ($sra_id != '') {
    $query1 = "update eti_approve_details set approve_a = '1', approve_a_desc = '$approve_level_desc_a',
		...
		$body  = '<html>
				  ...
				  .link_button {
					...
					<body>
						...
						<div>Approved By: '.$approve_a_name.' : '.$approve_a_date_time.'</div><br />
						<div>
...
<div class="example-modal">
        <div class="modal modal-primary">
          <div class="modal-dialog">
		    <form action="approve_a.php" name="approve" id="approve" method="post">
