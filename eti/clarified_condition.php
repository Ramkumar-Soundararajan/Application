...
if ($_POST){
	...
	if ($sra_id != '') {
    $query1 = "update eti_approve_details set approve_condition = '4', approve_condition_desc = '$clarify_level_desc_a',approve_condition_date_time='$current_date',approve_condition_email='$clarify_email', approve_condition_name='$clarify_name' where id = '$sra_id'";
...
<div class="example-modal">
        <div class="modal modal-primary">
          <div class="modal-dialog">
		    <form action="clarified_condition.php" name="clarify" id="clarify" onsubmit="return validateForm()" method="post">
