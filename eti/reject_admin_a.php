...
if ($_POST){
	$reject_level_desc_a = mysql_real_escape_string($_POST['reject_level_desc_a']);
	$eti_id = $_POST['eti'];
	$email = $_POST['email'];
	...
	if ($sra_id != '') {
    $query1 = "update eti_approve_details set approve_contract_admin = '5', approve_contract_admin_desc = '$reject_level_desc_a',
	...
	$query6 = "insert into eti_approve_details (sra_id,approve_contract_admin,approve_contract_admin_desc,approve_contract_admin_date_time,approve_contract_admin_email,approve_contract_admin_name) 
				values('$eti_id','5','$reject_level_desc_a','$current_date','$email','$email_name')";
...
<div class="example-modal">
        <div class="modal modal-primary">
          <div class="modal-dialog">
		    <form action="reject_admin_a.php" name="reject" id="reject" onsubmit="return validateForm()" method="post">
