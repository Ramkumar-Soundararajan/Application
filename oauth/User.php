...
//exit;
class User {
    private $dbHost     = 'new-sg-fumigation.cehmmc7pkgr1.us-east-2.rds.amazonaws.com:4491';
    private $dbUsername = 'furisgdm';
    private $dbPassword = '#j$Ej23!9Sec$mCddD!Bz';
    private $dbName     = 'rentokil_eti';
    private $userTbl    = 'oauth_users';
