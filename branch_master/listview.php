          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
					$query2 = "select * from eti_branch_master";
				...
				?>
                <tr>
                  <td><?php echo $res2['branch_name']; ?></td>
                  <td><?php echo $res12['country_name']; ?></td>
                  <td><?php echo $res2['branch_icabs_id'];?></td>
                  ...
                  <td><?php if ($res2['deleted'] == 0 ){ ?><a href="editview.php?branch_id=<?php echo $res2['id']; ?>"><i class="fa fa-edit"></i></a> &nbsp; <?php if ($access_rights =='0'){ ?><a href="deleteview.php?branch_id=<?php echo $res2['id']; ?>"><i class="fa fa-trash"></i></a><?php }} ?></td>
                </tr>
				<?php } ?>
                </tbody>
                <tfoot>
