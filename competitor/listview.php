        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo $manage_competitor_lbl; ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th><?php echo $competitor_name_lbl; ?></th>
                ...
                <tbody>
				<?php
					$query2 = "select * from eti_competitor";
					$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
					while ($res2 = mysql_fetch_array($exec2))
					{
				?>
                <tr>
                  <td><?php echo $res2['competitor_name']; ?></td>
                  ...
                  <td><?php if ($res2['deleted'] == 0 ){ ?><a href="editview.php?competitor_id=<?php echo $res2['id']; ?>"><i class="fa fa-edit"></i></a> &nbsp; <a href="deleteview.php?competitor_id=<?php echo $res2['id']; ?>"><i class="fa fa-trash"></i></a><?php } ?></td>
                </tr>
				<?php } ?>
                </tbody>
                <tfoot>
